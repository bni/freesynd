...
const fs_eng::FrameEvent intro[] = {
    {   1, 17,               0x0, "" }, // Play track
    {  15, fs_eng::kNoSound, 0x0, "INTRO_0" },
    {  29, 0,                0x0, NULL },  // Sound car
    {  39, fs_eng::kNoSound, 0x1, "" }, // clear subtitle
    {  44, fs_eng::kNoSound, 0x0, "INTRO_1" },
    {  50, 1,                0x1, NULL }, // Sound train
    {  62, fs_eng::kNoSound, 0x0, "" }, // clear subtitle
    {  67, fs_eng::kNoSound, 0x0, "INTRO_2" },
    {  85, fs_eng::kNoSound, 0x0, "" }, // clear
    {  90, fs_eng::kNoSound, 0x0, "INTRO_3" },
    { 117, fs_eng::kNoSound, 0x0, "" }, // clear
    { 121, fs_eng::kNoSound, 0x0, "INTRO_4" },
    { 135, fs_eng::kNoSound, 0x0, "" }, // clear
    { 138, fs_eng::kNoSound, 0x0, "INTRO_5" },
    { 153, fs_eng::kNoSound, 0x0, "INTRO_6" },
    { 165, fs_eng::kNoSound, 0x0, "INTRO_7" },
    { 167, 10,               0x1, NULL }, // Sound car start
    { 174, fs_eng::kNoSound, 0x0, "" }, // Clear
    { 176, fs_eng::kNoSound, 0x0, "INTRO_8" },
    { 181, 9,               0x0, NULL }, // Sound car run
    { 200, fs_eng::kNoSound, 0x0, "" }, // clear
    { 215, 2,               0x0, NULL }, // Bip 1
    { 222, 2,               0x0, NULL }, // Bip 2
    { 229, 2,               0x0, NULL }, // Bip 3
    { 234, fs_eng::kNoSound, 0x0, "INTRO_9" },
    { 236, 2,               0x0, NULL }, // Bip 4
    { 243, 2,               0x0, NULL }, // Bip 5
    { 250, 2,               0x0, NULL }, // Bip 6
    { 257, 2,               0x0, NULL }, // Bip 7
    { 264, 2,               0x0, NULL }, // Bip 8
    { 269, 11,               0x0, NULL }, // car accelerate
    { 271, fs_eng::kNoSound, 0x0, "" },//clear
    { 291, fs_eng::kNoSound, 0x0, "INTRO_10" },
    { 314, 12,               0x0, NULL }, // 1st Door open
    { 327, 12,               0x0, NULL }, // 2nd Door closed
    { 333, fs_eng::kNoSound, 0x0, "" }, // Clear
    { 345, 12,               0x1, NULL }, // 2nd Door open
    { 359, fs_eng::kNoSound, 0x0, "INTRO_11" },
    { 406, fs_eng::kNoSound, 0x0, "" }, // clear
    { 421, 4,               0x1, NULL }, // Lab door open
    { 442, fs_eng::kNoSound, 0x0, "INTRO_12" },
    { 444, 16,               0x0, NULL }, // glow
    { 455, 14,               0x1, NULL }, // levitate
    { 466, 15,               0x1, NULL }, // end levitate
    { 467, fs_eng::kNoSound, 0x0, "" }, // clear
    { 473, fs_eng::kNoSound, 0x0, "INTRO_13" },
    { 482, 6,               0x0, NULL }, // round
    { 502, fs_eng::kNoSound, 0x0, "" }, // clear
    { 520, 7,               0x0, NULL }, // leg
    { 530, 8,               0x0, NULL }, // leg
    { 540, 7,               0x0, NULL }, // leg
    { 548, fs_eng::kNoSound, 0x0, "INTRO_14" },
    { 550, 6,               0x0, NULL }, // round back
    { 562, fs_eng::kNoSound, 0x0, "" },
    { 569, fs_eng::kNoSound, 0x0, "INTRO_15" },
    { 576, 3,               0x0, NULL }, // weld
    { 586, 3,               0x0, NULL }, // weld
    { 598, 3,               0x0, NULL }, // weld
    { 610, fs_eng::kNoSound, 0x0, "" },
    { 612, 3,               0x0, NULL }, // weld
    { 617, 13,               0x0, NULL }, // chip
    { 634, 17,               0x0, NULL }, // Menu
    { 639, fs_eng::kNoSound, 0x0, "INTRO_16" },
    { 645, 24,               0x1, NULL }, // Menu screen 1
    { 659, 23,               0x1, NULL }, // Menu screen 3
    { 670, 21,               0x1, NULL }, // Screen
    { 673, fs_eng::kNoSound, 0x0, "" },
    { 679, 25,               0x1, NULL }, // Screen
    { 691, 26,               0x1, NULL }, // Screen
    { 700, 27,               0x1, NULL }, // Screen
    { 702, 29,               0x1, NULL }, // Screen
    { 710, 27,               0x1, NULL }, // Screen
    { 714, 29,               0x1, NULL }, // Screen
    { 720, 27,               0x1, NULL }, // Screen
    { 724, 29,               0x1, NULL }, // Screen
    { 730, 13,               0x1, NULL }, // Screen
    { 750, 29,               0x1, NULL }, // Screen
    { 760, 30,               0x0, NULL }, // Bip 1
    { 764, 30,               0x0, NULL }, // Bip 1
    { 768, 30,               0x0, NULL }, // Bip 1
    { 772, 30,               0x0, NULL }, // Bip 1
    { 776, 30,               0x0, NULL }, // Bip 1
    { 780, 30,               0x0, NULL }, // Bip 1
    { 784, 18,               0x0, NULL }, // car
    { 796, 19,               0x1, NULL }, // train
    { 848, fs_eng::kNoSound, 0x0, "INTRO_17" },
    { 868, 2,               0x0, NULL }, // Bip 1
    { 874, 2,               0x0, NULL }, // Bip 2
    { 880, 2,               0x0, NULL }, // Bip 3
    { 886, 2,               0x0, NULL }, // Bip 4
    { 892, fs_eng::kNoSound, 0x0, "" },
    { 893, 2,               0x0, NULL }, // Bip 5
    { 899, 2,               0x0, NULL }, // Bip 6
    { 904, fs_eng::kNoSound, 0x0, "INTRO_18" },
    { 910, 24,               0x0, NULL }, // Gun out
    { 911, fs_eng::kNoSound, 0x0, "" },
    { 928, 31,               0x0, NULL }, // Gun shot
    { 932, 32,               0x0, NULL }, // Letter S
    { 935, 32,               0x0, NULL }, // Letter Y
    { 938, 32,               0x0, NULL }, // Letter N
    { 941, 32,               0x0, NULL }, // Letter D
    { 944, 32,               0x0, NULL }, // Letter I
    { 947, 32,               0x0, NULL }, // Letter C
    { 950, 32,               0x0, NULL }, // Letter A
    { 953, 32,               0x0, NULL }, // Letter T
    { 956, 32,               0x0, NULL }, // Letter E
    { 966, 33,               0x0, NULL }, // 
...
const fs_eng::FrameEvent mission_win[] = {
    { 1, fs_eng::APPLAUSE,              0x1, NULL },
    { 1, fs_eng::APPLAUSE_ZOOM,         0x0, NULL },
    { 10, fs_eng::FIREWORKS,            0x1, NULL },
    { 30, fs_eng::FIREWORKS_APPLAUSE,   0x1, NULL },
    { -1, fs_eng::kNoSound,              0x0, NULL }
};
...
const fs_eng::FrameEvent mission_failed[] = {
    { 1, fs_eng::kNoSound, 0x0, NULL },
    { 35, fs_eng::PRESS_BUTTON, 0x0, NULL },
    { 52, fs_eng::MENU_AFTER_MISSION, 0x0, NULL },
    { 80, fs_eng::SPEECH_NO, 0x0, NULL },
    { 108, fs_eng::MONITOR_IMPACT, 0x0, NULL },
    { 118, fs_eng::GLASS_BREAKING_2, 0x0, NULL },
    { -1, fs_eng::kNoSound, 0x0, NULL }
};
...
const fs_eng::FrameEvent game_lost[] = {
    { 1, fs_eng::kNoSound, 0x0, NULL },
    { 2, fs_eng::FALLING_COMMAND_SHIP, 0x0, NULL },
    { 34, fs_eng::EXPLOSION_BIG, 0x0, NULL },
    { -1, fs_eng::kNoSound, 0x0, NULL }
};
...
fs_eng::Menu * GameMenuFactory::createFliMenu(const int menuId) {
    ...
    if (pMenu->getId() == fs_game_menus::kMenuIdFliSuccess || menuId == fs_game_menus::kMenuIdFliFailedMission) {
        ...
        if ( menuId == fs_game_menus::kMenuIdFliIntro) {
            ...
            pMenu->addFliDesc("intro.dat", 95, false, true, true, intro, fs_eng::kSampleIntro, fs_eng::MusicManager::kMusicSongIntro);
        }
        // Display the splash screen
        pMenu->addFliDesc("mtitle.dat", 66, true, true, false, title, fs_eng::kSampleIntro);
        // common fli to prepare next menu show
        pMenu->addFliDesc("mscrenup.dat", 20, false, false, false, menu_up);
