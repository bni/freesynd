...
TEST_CASE( "Squad", "[kernel][squad]" ) {
    ...
    fs_knl::Squad cut;
    fs_knl::PedInstance agent1(nullptr, 1, nullptr, true);
    fs_knl::PedInstance agent2(nullptr, 2, nullptr, true);
    fs_knl::PedInstance agent3(nullptr, 3, nullptr, true);
    fs_knl::PedInstance agent4(nullptr, 4, nullptr, true);
    agent1.setHealth(10);
    agent2.setHealth(10);
    agent3.setHealth(10);
    agent4.setHealth(10);
