...
{
    Point2D posWithOffs;
    posWithOffs.x = (((pos_.ox - pos_.oy) * (fs_eng::Tile::kTileWidth / 2)) / 256) + screenPos.x;
    posWithOffs.y = (((pos_.ox + pos_.oy) * (fs_eng::Tile::kTileHeight / 3)) / 256) + screenPos.y;
    posWithOffs.y -= (pos_.oz * (fs_eng::Tile::kTileHeight / 3)) / 128;
